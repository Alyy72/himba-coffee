...
export const metadata: Metadata = {
  title: "Gallery",
  description:
    "High-resolution looks at Himba tumblers in the wild — Matte Black, Snow White, and Himalayan Pink.",
};
      ...
      <section className="relative overflow-hidden bg-[#0A0A0A] px-6 pt-16 pb-20 md:px-10 md:pt-24 md:pb-28">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <p className="mt-5 max-w-lg text-lg text-white/45">
            Matte Black, Snow White, and Himalayan Pink — captured where real
            coffee moments happen. Swap these placeholders for your photos
            anytime.
          </p>
          ...
          <div className="mt-20 flex flex-col items-start justify-between gap-8 border-t border-white/10 pt-14 md:mt-28 md:flex-row md:items-end">
            <div>
              <p className="text-[11px] tracking-[0.28em] text-white/40 uppercase">
                Ready
              </p>
              <h2 className="mt-3 max-w-md text-[clamp(1.75rem,4vw,2.75rem)] leading-[1.05] font-semibold tracking-[-0.03em] text-[#F2F2F2]">
                Take one home.
              </h2>
            </div>
            <Link
