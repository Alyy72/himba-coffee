    ...
    <>
      ...
      >
        <button
          ...
          onClick={openInspect}
          className={cn(
            "relative aspect-[4/5] w-full overflow-hidden text-left",
            product.category === "tumblers" ? "bg-white" : "bg-[#121212]",
          )}
        >
          <Image
            src={displayImage}
          ...
          <span
            className={cn(
              "absolute top-3 right-3 inline-flex items-center gap-1.5 px-2.5 py-1.5 text-[10px] tracking-[0.16em] uppercase backdrop-blur-sm transition-colors",
              product.category === "tumblers"
                ? "bg-black/10 text-black/55 group-hover:text-black/80"
                : "bg-black/50 text-white/70 group-hover:text-white",
            )}
          >
