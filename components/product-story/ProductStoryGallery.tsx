  ...
  return (
    ...
    >
      <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-16">
        <div className="relative aspect-[4/5] w-full overflow-hidden border border-white/8 bg-white">
          <Image
            src={tumbler.image}
    ...
    <div className="relative mx-auto max-w-6xl">
      ...
      >
        ...
        <p className="mt-5 max-w-xl text-lg text-white/45">
          Explore each Himba finish and the components behind the ritual — from
          vacuum walls to the color-matched straw.
        </p>
      </motion.div>
