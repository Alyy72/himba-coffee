...
export function Hero() {
  return (
    <section className="relative flex min-h-svh w-full flex-col overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 pt-24 pb-10 md:px-10 md:pt-28">
