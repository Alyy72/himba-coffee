...
export function Configurator() {
  ...
  return (
    <section className="relative min-h-svh overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="relative mx-auto grid min-h-svh max-w-7xl lg:grid-cols-2">
        {/* Preview pane */}
        <div className="relative flex min-h-[62svh] items-center justify-center bg-white px-6 pt-24 pb-14 lg:min-h-full lg:px-12 lg:pt-28">
          <motion.div
            layout
          ...
          >
            ...
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="mt-8 text-center text-xs tracking-[0.28em] text-black/40 uppercase"
              >
