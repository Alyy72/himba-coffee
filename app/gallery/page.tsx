...
export const metadata: Metadata = {
  title: "Gallery",
  description:
    "Product story gallery — Pure White, Matte Black, Lavender Botanical, and Soft Pink Himba tumblers in detail.",
};

export default function GalleryPage() {
  return (
    <main className="flex-1">
      <section className="relative overflow-hidden bg-[#0A0A0A] px-6 pt-28 pb-8 md:px-10 md:pt-32">
        <div
          aria-hidden
